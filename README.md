# NoteBlockSongs
The most complete NBS songs as far as I know that contains at least 600 songs. Provided by multiples sources accros the years. Duplicate can exist.
- Use in any program that can uses .nbs files
- Make your own with NoteBlock Studio

### Installation
Depending on the plugin, drag any .nbs file into the right folder. Many plugins uses /<PLUGINNAME>/songs. 

### List of public plugins that can use theses .nbs files.
Basicly any NoteBlockAPI compatible plugin.
...
<tr>
<td>GMusic</td>
<td>NOT COMPATIBLE - WEIRD .NBS RENDER - https://youtu.be/IJz2tcWhOyw - https://github.com/gecolay/GMusic/issues/9</td>
</tr>
</tbody>
</table>
...
### Notable links
NoteBlockStudio: <a href="https://www.stuffbydavid.com/mcnbs">https://www.stuffbydavid.com/mcnbs</a><br>
OpenNBS: <a href="https://opennbs.org/">https://opennbs.org/</a>
